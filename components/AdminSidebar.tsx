...
import { LayoutDashboard, ClipboardList, Warehouse, Package, Tags, LogOut } from 'lucide-react';

interface AdminSidebarProps {
  activeTab: string;
  setActiveTab: (tab: 'dashboard' | 'products' | 'warehouse' | 'categories' | 'transactions') => void;
  onLogout: () => void;
}
