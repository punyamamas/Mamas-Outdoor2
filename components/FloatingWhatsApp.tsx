  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div className="bg-[#25D366] hover:bg-[#20bd5a] text-white p-4 rounded-full shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] transition-all duration-300 transform group-hover:scale-110 group-hover:rotate-12 flex items-center justify-center relative z-10 border-2 border-white">
          <MessageCircle size={28} fill="white" className="text-[#25D366]" />
        </div>

        {/* Notification Badge (Fake) */}
        <span className="absolute -top-1 -right-1 bg-red-500 border-2 border-white text-white text-[10px] font-bold w-5 h-5 flex items-center justify-center rounded-full z-20">
          1
        </span>
      </div>
    </a>
