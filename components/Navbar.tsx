...
const Navbar: React.FC<NavbarProps> = ({ cartCount, onOpenCart, onToggleMobileMenu, isMobileMenuOpen }) => {
  return (
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <a href="#ai-guide" className="block py-3 px-2 text-base font-medium text-gray-700">Tanya AI Assistant</a>
          </div>
        </div>
      )}
    </nav>
